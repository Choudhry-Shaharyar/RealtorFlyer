            ...
            <div className="container px-4 md:px-6">
                ...
                <div className="grid md:grid-cols-3 gap-12 relative max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col items-center text-center relative z-10">
                        ...
                        <h3 className="text-xl font-bold text-brand-navy mb-2">1. Upload Property Details</h3>
                    ...
                    <div className="flex flex-col items-center text-center relative z-10">
                        ...
                        <h3 className="text-xl font-bold text-brand-navy mb-2">2. Choose Flyer Design</h3>
                    ...
                    <div className="flex flex-col items-center text-center relative z-10">
                        ...
                        <h3 className="text-xl font-bold text-brand-navy mb-2">3. Download Marketing Flyer</h3>
