...
export async function POST(
    ...
    try {
        ...
        const flyerParams: FlyerParams = {
            ...
            soldPrice: body.soldPrice || undefined,
            soldOverAsking: body.soldOverAsking || false,
            openHouseDate: body.openHouseDate || undefined,
            openHouseTime: body.openHouseTime || undefined,
